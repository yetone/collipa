...
c);e.pasteFilter&&d.addListener("beforepaste",c);c.call(d)}})};UE.plugins.autosubmit=function(){this.commands.autosubmit={execCommand:function(){var a=f.findParentByTagName(this.iframe,"form",!1);a&&!1!==this.fireEvent("beforesubmit")&&(this.sync(),a.submit())}};this.addshortcutkey({})};UE.plugins.background=function(){var a=this;a.addListener("getAllHtml",function(b,c){var d=this.body,e=f.getComputedStyle(d,"background-image"),g="",g=0<e.indexOf(a.options.imagePath)?e.substring(e.indexOf(a.options.imagePath),
...
f.filterNodeList(this.selection.getStartElementPath(),function(a){return f.isBlockElm(a)});if(a)return a=f.getComputedStyle(a,"line-height"),"normal"==a?1:a.replace(/[^\d.]*/ig,"")}}};UE.plugins.insertcode=function(){var a=this;a.ready(function(){p.cssRule("pre","pre{margin:.5em 0;padding:.4em .6em;border-radius:8px;background:#f8f8f8;line-height:1.5}",a.document)});a.setOpt("insertcode",{python:"Python",ruby:"Ruby",js:"JavaScript",php:"Php",pl:"Perl",cpp:"C/C++",java:"Java",erlang:"Erlang",scala:"Scala",
bash:"Bash/Shell"});a.commands.insertcode={execCommand:function(a,c){var d=this.selection.getRange(),e=f.findParentByTagName(d.startContainer,"pre",!0);if(e)e.className="brush:"+c+";toolbar:false;";else{var g="";d.collapsed?g=n.ie?8<n.version?"":"&nbsp;":"<br/>":(e=d.extractContents(),d=this.document.createElement("div"),d.appendChild(e),p.each(UE.filterNode(UE.htmlparser(d.innerHTML.replace(/[\r\t]/g,"")),this.options.filterTxtRules).children,function(a){n.ie&&8<n.version?("element"==a.type?"br"==
a.tagName?g+="\n":t.$empty[a.tagName]||(p.each(a.children,function(b){"element"==b.type?"br"==b.tagName?g+="\n":t.$empty[a.tagName]||(g+=b.innerText()):g+=b.data}),/\n$/.test(g)||(g+="\n")):g+=a.data+"\n",!a.nextSibling()&&/\n$/.test(g)&&(g=g.replace(/\n$/,""))):n.ie?("element"==a.type?"br"==a.tagName?g+="<br>":t.$empty[a.tagName]||(p.each(a.children,function(b){"element"==b.type?"br"==b.tagName?g+="<br>":t.$empty[a.tagName]||(g+=b.innerText()):g+=b.data}),/br>$/.test(g)||(g+="<br>")):g+=a.data+"<br>",
!a.nextSibling()&&/<br>$/.test(g)&&(g=g.replace(/<br>$/,""))):(g+="element"==a.type?t.$empty[a.tagName]?"":a.innerText():a.data,!/br\/?\s*>$/.test(g)&&a.nextSibling()&&(g+="<br>"))}));this.execCommand("inserthtml",'<pre id="coder"class="brush:'+c+';toolbar:false">'+g+"</pre>",!0);e=this.document.getElementById("coder");f.removeAttributes(e,"id");(d=e.previousSibling)&&f.isEmptyBlock(d)&&f.remove(d);d=this.selection.getRange();f.isEmptyBlock(e)?d.setStart(e,0).setCursor(!1,!0):d.selectNodeContents(e).select()}},
queryCommandValue:function(){var a=this.selection.getStartElementPath(),c="";p.each(a,function(a){if("PRE"==a.nodeName)return c=(a=a.className.match(/brush:([^;]+)/))&&a[1]?a[1]:"",!1});return c}};a.addInputRule(function(a){p.each(a.getNodesByTagName("pre"),function(a){var b=a.getNodesByTagName("br");b.length?n.ie&&8<n.version&&p.each(b,function(a){var b=UE.uNode.createText("\n");a.parentNode.insertBefore(b,a);a.parentNode.removeChild(a)}):n.ie&&8<n.version||(b=a.innerText().split(/\n/),a.innerHTML(""),
p.each(b,function(b){b.length&&a.appendChild(UE.uNode.createText(b));a.appendChild(UE.uNode.createElement("br"))}))})});a.addOutputRule(function(a){p.each(a.getNodesByTagName("pre"),function(a){var b="";p.each(a.children,function(a){b="text"==a.type?b+a.data.replace(/[ ]/g,"&nbsp;"):b+"\n"});a.innerText(b.replace(/(&nbsp;|\n)+$/,""))})});a.notNeedCodeQuery={help:1,undo:1,redo:1,source:1,print:1,searchreplace:1,fullscreen:1,preview:1,insertparagraph:1,elementpath:1,highlightcode:1,insertcode:1,inserthtml:1,
selectall:1};a.queryCommandState=function(a){return!this.notNeedCodeQuery[a.toLowerCase()]&&this.selection&&this.queryCommandValue("insertcode")?-1:UE.Editor.prototype.queryCommandState.apply(this,arguments)};a.addListener("beforeenterkeydown",function(){var b=a.selection.getRange(),c=f.findParentByTagName(b.startContainer,"pre",!0);if(c){a.fireEvent("saveScene");b.collapsed||b.deleteContents();if(n.ie)if(8<n.version){var c=a.document.createTextNode("\n"),d=b.startContainer;if(0==b.startOffset){if(d.previousSibling){b.insertNode(c);
var e=a.document.createTextNode(" ");b.setStartAfter(c).insertNode(e).setStart(e,0).collapse(!0).select(!0)}}else b.insertNode(c).setStartAfter(c),e=a.document.createTextNode(" "),(d=b.startContainer.childNodes[b.startOffset])&&!/^\n/.test(d.nodeValue)&&b.setStartBefore(c),b.insertNode(e).setStart(e,0).collapse(!0).select(!0)}else{c=a.document.createElement("br");b.insertNode(c);b.insertNode(a.document.createTextNode(f.fillChar));b.setStartAfter(c);for(c=c.previousSibling;c;)if(d=c,c=c.previousSibling,
...
c,c=c.previousSibling,!c||"BR"==c.nodeName){c=d;break}if(c){for(d="";c&&"BR"!=c.nodeName&&RegExp("^[\\s"+f.fillChar+"]*$").test(c.nodeValue);)d+=c.nodeValue,c=c.nextSibling;"BR"!=c.nodeName&&(c=c.nodeValue.match(RegExp("^([\\s"+f.fillChar+"]+)")))&&c[1]&&(d+=c[1]);d&&(d=a.document.createTextNode(d),b.insertNode(d).setStartAfter(d))}b.collapse(!0).select(!0)}a.fireEvent("saveScene");return!0}});a.addListener("tabkeydown",function(b,c){var d=a.selection.getRange(),e=f.findParentByTagName(d.startContainer,
"pre",!0);if(e){a.fireEvent("saveScene");if(!c.shiftKey)if(d.collapsed)e=a.document.createTextNode("    "),d.insertNode(e).setStartAfter(e).collapse(!0).select(!0);else{for(var g=d.createBookmark(),h=g.start.previousSibling;h;){if(e.firstChild===h&&!f.isBr(h)){e.insertBefore(a.document.createTextNode("    "),h);break}if(f.isBr(h)){e.insertBefore(a.document.createTextNode("    "),h.nextSibling);break}h=h.previousSibling}var j=g.end,h=g.start.nextSibling;for(e.firstChild===g.start&&e.insertBefore(a.document.createTextNode("    "),
h.nextSibling);h&&h!==j;){if(f.isBr(h)&&h.nextSibling){if(h.nextSibling===j)break;e.insertBefore(a.document.createTextNode("    "),h.nextSibling)}h=h.nextSibling}d.moveToBookmark(g).select()}a.fireEvent("saveScene");return!0}});a.addListener("beforeinserthtml",function(a,c){var d=this,e=d.selection.getRange();if(f.findParentByTagName(e.startContainer,"pre",!0)){e.collapsed||e.deleteContents();var g="";if(n.ie&&8<n.version){p.each(UE.filterNode(UE.htmlparser(c),d.options.filterTxtRules).children,function(a){"element"==
a.type?"br"==a.tagName?g+="\n":t.$empty[a.tagName]||(p.each(a.children,function(b){"element"==b.type?"br"==b.tagName?g+="\n":t.$empty[a.tagName]||(g+=b.innerText()):g+=b.data}),/\n$/.test(g)||(g+="\n")):g+=a.data+"\n";!a.nextSibling()&&/\n$/.test(g)&&(g=g.replace(/\n$/,""))});var h=d.document.createTextNode(p.html(g.replace(/&nbsp;/g," ")));e.insertNode(h).selectNode(h).select()}else{var j=d.document.createDocumentFragment();p.each(UE.filterNode(UE.htmlparser(c),d.options.filterTxtRules).children,
function(a){"element"==a.type?"br"==a.tagName?j.appendChild(d.document.createElement("br")):t.$empty[a.tagName]||(p.each(a.children,function(b){"element"==b.type?"br"==b.tagName?j.appendChild(d.document.createElement("br")):t.$empty[a.tagName]||j.appendChild(d.document.createTextNode(p.html(b.innerText().replace(/&nbsp;/g," ")))):j.appendChild(d.document.createTextNode(p.html(b.data.replace(/&nbsp;/g," "))))}),"BR"!=j.lastChild.nodeName&&j.appendChild(d.document.createElement("br"))):j.appendChild(d.document.createTextNode(p.html(a.data.replace(/&nbsp;/g,
...
c.commands.pagebreak={execCommand:function(){var e=c.selection.getRange(),g=c.document.createElement("hr");f.setAttributes(g,{"class":"pagebreak",noshade:"noshade",size:"5"});f.unSelectable(g);var h=f.findParentByTagName(e.startContainer,d,!0),j=[];if(h)switch(h.tagName){case "TD":h=h.parentNode,h.previousSibling?(h.parentNode.insertBefore(g,h),j=f.findParents(g)):(e=f.findParentByTagName(h,"table"),e.parentNode.insertBefore(g,e),j=f.findParents(g,!0)),h=j[1],g!==h&&f.breakParent(g,h),c.fireEvent("afteradjusttable",
c.document)}else{if(!e.collapsed){e.deleteContents();for(h=e.startContainer;!f.isBody(h)&&f.isBlockElm(h)&&f.isEmptyNode(h);)e.setStartBefore(h).collapse(!0),f.remove(h),h=e.startContainer}e.insertNode(g);for(h=g.parentNode;!f.isBody(h);)f.breakParent(g,h),(h=g.nextSibling)&&f.isEmptyBlock(h)&&f.remove(h),h=g.parentNode;h=g.nextSibling;j=g.previousSibling;b(j)?f.remove(j):j&&a(j);h?(b(h)?f.remove(h):a(h),e.setEndAfter(g).collapse(!1)):(h=c.document.createElement("p"),g.parentNode.appendChild(h),f.fillNode(c.document,
h),e.setStart(h,0).collapse(!0));e.select(!0)}}}};UE.plugins.wordimage=function(){var a=this,b;a.addInputRule(function(b){p.each(b.getNodesByTagName("img"),function(b){var c=b.attrs,f=128>parseInt(c.width)||43>parseInt(c.height),h=a.options,j=h.UEDITOR_HOME_URL+"themes/default/images/spacer.gif";c._src&&-1!==c._src.indexOf("file:///")&&b.setAttr({width:c.width,height:c.height,alt:c.alt,word_img:c._src,src:j,_src:j,style:"background:url("+(f?h.themePath+h.theme+"/images/word.gif":h.langPath+h.lang+
